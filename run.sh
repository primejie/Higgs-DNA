...
python scripts/run_analysis.py --config metadata/tutorial/hhggxx_analysis_data_withsyst.json --unretire_jobs --years 2017 --output_dir /eos/cms/store/group/phys_higgs/cmshgg/zhjie/custom_Nano/Data_2017  --batch_system condor